const messages = {
    'zh-TW': {
        ...
        disableTip: '停用翻譯',
        fontSize: '翻譯文字大小',
        hiddenMode: '啟用隱藏模式（點擊才顯示翻譯）',
        selectionSection: '劃詞翻譯',
        selectionEnable: '啟用劃詞翻譯',
        selectionAutoPopup: '選取文字後自動顯示翻譯',
    ...
    'zh-CN': {
        ...
        disableTip: '停用翻译',
        fontSize: '翻译文字大小',
        hiddenMode: '启用隐藏模式（点击才显示翻译）',
        selectionSection: '划词翻译',
        selectionEnable: '启用划词翻译',
        selectionAutoPopup: '选取文字后自动显示翻译',
    ...
    ja: {
        ...
        disableTip: '翻訳を無効にする',
        fontSize: '翻訳フォントサイズ',
        hiddenMode: '隠しモード（クリックで翻訳を表示）',
        selectionSection: '選択翻訳',
        selectionEnable: '選択翻訳を有効にする',
        selectionAutoPopup: '選択時に自動で翻訳を表示',
    ...
    ko: {
        ...
        disableTip: '번역 비활성화',
        fontSize: '번역 글꼴 크기',
        hiddenMode: '숨김 모드 (클릭하여 번역 표시)',
        selectionSection: '선택 번역',
        selectionEnable: '선택 번역 활성화',
        selectionAutoPopup: '선택 시 자동으로 번역 표시',
